...
export type TicketCategory = "it" | "facility" | "logistics";
...
const INITIAL: Ticket[] = [
  ...
  { id: "T-103", title: "Neue Schürzen fehlen", desc: "3 Mitarbeiter ohne saubere Schürzen für Wochenende.", category: "logistics", status: "open", priority: "med", author: "Tom B.", pubId: "red-lion", ago: "vor 5h" },
  ...
  { id: "T-098", title: "Onboarding-Material fehlt", desc: "Welcome-Pack für neue Aushilfskraft ist leer.", category: "logistics", status: "done", priority: "med", author: "Markus K.", pubId: "tipsy-fox", ago: "vor 4 Tagen" },
