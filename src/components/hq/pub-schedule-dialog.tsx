                ...
                <div className="space-y-1">
                  {data.employees.map((emp) => {
                    ...
                    return (
                      ...
                      >
                        <div className="px-2 py-2 min-w-0 flex items-center gap-2">
                          <div className="min-w-0 flex-1">
                          ...
                          <div className="flex items-center gap-0.5 shrink-0">
                            <a
                              href={telLink(emp.phone)}
                              title={tt("Anrufen", "Call")}
                              className="h-7 w-7 rounded-md border bg-background hover:bg-accent flex items-center justify-center text-muted-foreground hover:text-foreground"
                            >
                              <Phone className="h-3.5 w-3.5" />
                            </a>
                            <a
                              href={waLink(emp.phone, tt(`Hallo ${emp.name.split(" ")[0]},`, `Hi ${emp.name.split(" ")[0]},`))}
                              target="_blank"
                              rel="noopener noreferrer"
                              title="WhatsApp"
                              className="h-7 w-7 rounded-md border border-emerald-500/30 bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-600 flex items-center justify-center"
                            >
                              <MessageCircle className="h-3.5 w-3.5" />
                            </a>
                          </div>
